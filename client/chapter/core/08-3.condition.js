...
switch (thisTime) {
  ...
  case LUNCH:console.log('밥먹어야지 당연히');break;
  case DINNER:console.log('스터디 및 운동을해야해');break;
  case NIGHT:console.log('유튭두편정도 보고 복습');break;
  case LATE_NIGHT:
  case DAWN:console.log('잠을자야지 내일 잘일어나지');break;
}
...
if(thisTime === MORNING){
  ...
  console.log('밥먹어야지 당연히')
}else if(thisTime === LATE_NIGHT || thisTime === DAWN){
  console.log('잠을자야 내일 일어난다......')
}
